...
if(window.XMLHttpRequest){
    ...
    XMLHttpRequest.prototype.defaults = {
        ...
        "ContentType":"application/json"   //  "text/plain", "text/xml", "text/html", "application/octet-stream", "multipart/form-data", "application/x-www-form-urlencoded";
    };
    ...
    XMLHttpRequest.prototype.execute = function(){
        if(XHR.ready){
            ...
            XHR.setRequestHeader("X-CSRF-TOKEN", document.querySelector('head > meta[name="csrf-token"]').content);
...
/* HTMLElement *****************************************************************/
    ...
    HTMLElement.prototype.insert=function(tagName, attributes, content){
        this.innerHTML = "";
        var obj = document.create(tagName, attributes, content);
